...
Característica: Registrar hora de entrada
 ...
 @jornadasDeIngreso
  ...
  Escenario: llega a tiempo
      Dado que mi horario de trabajo es 'Diurno A' y es 'lunes' y mi codigo de trabajador es '20131'
  ...
  Escenario: no tiene jornada laboral ese dia
      Dado que mi horario de trabajo es 'Diurno A' y es 'martes' y mi codigo de trabajador es '20131'
      Cuando ingrese mi hora de entrada como '7:14:59'
  ...
  Escenario: llega atrasado
      Dado que mi horario de trabajo es 'Nocturno A' y es 'miercoles' y mi codigo de trabajador es '20150'
  ...
  Escenario: llega muy temprano
      Dado que mi horario de trabajo es 'Nocturno B' y es 'jueves' y mi codigo de trabajador es '20191'
